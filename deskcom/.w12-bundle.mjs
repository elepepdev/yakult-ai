...
var wp = (p) => {
  const v = p.getWorldPosition(new THREE3.Vector3());
  return `(${v.x.toFixed(3)},${v.y.toFixed(3)},${v.z.toFixed(3)})`;
};
console.log("root  :", wp(B.root));
console.log("hips  :", wp(B.hips));
console.log("lSh   :", wp(B.LS), " rSh:", wp(B.RS));
var wL = B.LH.getWorldPosition(new THREE3.Vector3());
console.log("lHand :", wp(B.LH), " rHand:", wp(B.RH));
console.log("lHand mirrored (about hips.x):", `(${(-(wL.x - B.hips.getWorldPosition(new THREE3.Vector3()).x) + B.hips.getWorldPosition(new THREE3.Vector3()).x).toFixed(3)},${wL.y.toFixed(3)},${wL.z.toFixed(3)})`);
console.log("lHand mirrored (about x=0)   :", `(${(-wL.x).toFixed(3)},${wL.y.toFixed(3)},${wL.z.toFixed(3)})`);
