...
class CharacterConfig(I18nMixin):
    ...
    model_type: str = Field(default="live2d", alias="model_type")
    ...
    DESCRIPTIONS: ClassVar[Dict[str, Description]] = {
        ...
        "live2d_model_name": Description(
            en="Name of the Live2D/VRM model to use", zh="使用的Live2D/VRM模型名称"
        ),
        "model_type": Description(
            en="Model type: 'live2d' or 'vrm'", zh="模型类型：'live2d' 或 'vrm'"
        ),
